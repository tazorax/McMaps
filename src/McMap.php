...
class McMap
{
    ...
    {
        //instantiate a new NBT structure
        $this->nbt = new NBTService();
        //populate the default data for a Minecraft map item
        $this->nbt->root[0] = array('name' => '', 'type' => NBTService::TAG_COMPOUND, 'value' => array(
            array('name' => 'data', 'type' => NBTService::TAG_COMPOUND, 'value' => array(
                //1:1 zoom
                array('name' => 'scale', 'type' => NBTService::TAG_BYTE, 'value' => 0),
                //'overworld' (vs 'nether')
                array('name' => 'dimenson', 'type' => NBTService::TAG_BYTE, 'value' => 0),
                //default map size
                array('name' => 'height', 'type' => NBTService::TAG_SHORT, 'value' => 128),
                array('name' => 'width', 'type' => NBTService::TAG_SHORT, 'value' => 128),
                //locate the map somewhere where the player is unlikely to ever step
                array('name' => 'xCenter', 'type' => NBTService::TAG_INT, 'value' => -12500000),
                array('name' => 'zCenter', 'type' => NBTService::TAG_INT, 'value' => -12500000),
                //start with a blank map
                array(
                    'name' => 'colors', 'type' => NBTService::TAG_BYTE_ARRAY,
        ...
        foreach (array(
                     ...
                     array('r' => 67, 'g' => 94, 'b' => 29),    //7  Grass
                     array('r' => 174, 'g' => 164, 'b' => 115),    //8  Sand/Gravel
                     array('r' => 213, 'g' => 201, 'b' => 140),    //9  Sand/Gravel
                     array('r' => 247, 'g' => 233, 'b' => 163),    //10 Sand/Gravel
                     array('r' => 130, 'g' => 123, 'b' => 86),    //11 Sand/Gravel
                     array('r' => 117, 'g' => 117, 'b' => 117),    //12 Other
                     array('r' => 144, 'g' => 144, 'b' => 144),    //13 Other
                     array('r' => 167, 'g' => 167, 'b' => 167),    //14 Other
                     array('r' => 88, 'g' => 88, 'b' => 88),    //15 Other
                     array('r' => 180, 'g' => 0, 'b' => 0),    //16 Lava/TNT
                     array('r' => 220, 'g' => 0, 'b' => 0),    //17 Lava/TNT
                     array('r' => 255, 'g' => 0, 'b' => 0),    //18 Lava/TNT
                     array('r' => 135, 'g' => 0, 'b' => 0),    //19 Lava/TNT
                     array('r' => 112, 'g' => 112, 'b' => 180),    //20 Ice/Packed Ice
                     array('r' => 138, 'g' => 138, 'b' => 220),    //21 Ice/Packed Ice
                     array('r' => 160, 'g' => 160, 'b' => 255),    //22 Ice/Packed Ice
                     array('r' => 84, 'g' => 84, 'b' => 135),    //23 Ice/Packed Ice
                     array('r' => 117, 'g' => 117, 'b' => 117),    //24 Metal
                     array('r' => 144, 'g' => 144, 'b' => 144),    //25 Metal
                     array('r' => 167, 'g' => 167, 'b' => 167),    //26 Metal
                     array('r' => 88, 'g' => 88, 'b' => 88),    //27 Metal
                     array('r' => 0, 'g' => 87, 'b' => 0),    //28 Plants
                     array('r' => 0, 'g' => 106, 'b' => 0),    //29 Plants
                     array('r' => 0, 'g' => 124, 'b' => 0),    //30 Plants
                     array('r' => 0, 'g' => 65, 'b' => 0),    //31 Plants
                     array('r' => 180, 'g' => 180, 'b' => 180),    //32 Snow
                     array('r' => 220, 'g' => 220, 'b' => 220),    //33 Snow
                     array('r' => 255, 'g' => 255, 'b' => 255),    //34 Snow
                     array('r' => 135, 'g' => 135, 'b' => 135),    //35 Snow
                     array('r' => 115, 'g' => 118, 'b' => 129),    //36 Clay
                     array('r' => 141, 'g' => 144, 'b' => 158),    //37 Clay
                     array('r' => 164, 'g' => 168, 'b' => 184),    //38 Clay
                     array('r' => 86, 'g' => 88, 'b' => 97),    //39 Clay
                     array('r' => 129, 'g' => 74, 'b' => 33),    //40 Dirt
                     array('r' => 157, 'g' => 91, 'b' => 40),    //41 Dirt
                     array('r' => 183, 'g' => 106, 'b' => 47),    //42 Dirt
                     array('r' => 96, 'g' => 56, 'b' => 24),    //43 Dirt
                     array('r' => 79, 'g' => 79, 'b' => 79),    //44 Stone/Cobblestone/Ore
                     array('r' => 96, 'g' => 96, 'b' => 96),    //45 Stone/Cobblestone/Ore
                     array('r' => 112, 'g' => 112, 'b' => 112),    //46 Stone/Cobblestone/Ore
                     array('r' => 59, 'g' => 59, 'b' => 59),    //47 Stone/Cobblestone/Ore
                     array('r' => 45, 'g' => 45, 'b' => 180),    //48 Water
                     array('r' => 55, 'g' => 55, 'b' => 220),    //49 Water
                     array('r' => 64, 'g' => 64, 'b' => 255),    //50 Water
                     array('r' => 33, 'g' => 33, 'b' => 135),    //51 Water
    ...
    public function load($file)
    {
        ...
        foreach ($this->nbt->root[0]['value'][0]['value'] as &$node) {
            if ($node['name'] == 'colors') {
                break;
            }
        }
